...
```
exchangerate <command> [arguments] [flags]
```

Run `exchangerate <command> --help` for the full flag list on any command. This
...
per operation you declare in `exchangerate/domain.go`.
