...
Most of these come down to network reality or how exchangerate serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

exchangerate rate-limits like any public site. exchangerate already paces
...
Where a surface is gated, exchangerate reads a cookie or token you supply
...
`exchangerate`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what exchangerate actually did
