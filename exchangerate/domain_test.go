...
func TestHostWiring(t *testing.T) {
	...
	if want := "exchangerate://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("exchangerate", "about")
	if err != nil || got.String() != "exchangerate://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want exchangerate://page/about", got.String(), err)
	}
}
